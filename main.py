...
with st.sidebar:
    ...
    thread_id = st.text_input("👤 User ID", value="sakhawat_user",
...
QUICK = ["7-day Switzerland under $500", "Paris trip for 5 days", "Dubai weekend trip", "Bali backpacking 10 days"]
...
user_query = st.text_area(
    "Travel request",
    value=quick_fill,
    placeholder="e.g. Plan a complete 7-day Switzerland trip including flights, hotels and sightseeing under $500",
    height=100,
...
def get_app():
    return build_app(
        ...
        aviationstack_api_key=_secret("AVIATIONSTACK_API_KEY"),
    )
